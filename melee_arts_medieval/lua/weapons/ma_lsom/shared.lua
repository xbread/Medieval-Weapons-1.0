...
SWEP.Slot = 0
SWEP.PrintName = "Large Sword of Moonlight"
SWEP.Author = "Bread"
SWEP.Spawnable = true
...
SWEP.SlotPos = 1
SWEP.Purpose = "Large sword of moonlight its a large fucking sword of moonlight"
...
SWEP.DmgMin2 = 7
SWEP.DmgMax2 = 25
SWEP.ThrowModel = "models/demonssouls/weapons/large sword of moonlight.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
    ["hammer"] = {
        type = "Model",
        model = "models/demonssouls/weapons/large sword of moonlight.mdl",
        bone = "RW_Weapon",
        rel = "",
        pos = Vector(0.5, 0, 5),
        angle = Angle(90, 0, -90),
