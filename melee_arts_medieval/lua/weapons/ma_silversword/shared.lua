...
SWEP.SlotPos = 1
SWEP.Purpose = "A fast silver sword."
...
SWEP.ViewModelBoneMods = {
    ...
    ["RW_Weapon"] = {
        scale = Vector(0.076, 0.076, 0.076),
        pos = Vector(0, 0, 0),
        angle = Angle(0, 0, 0)
    },
    ["RightArm_1stP"] = {
        scale = Vector(1, 1, 1),
        pos = Vector(-1.668, 0, 0),
        angle = Angle(10, 0, 0)
    }
}
...
SWEP.VElements = {
    ["katana"] = {
        type = "Model",
        model = "models/aoc_weapon/sword_01_static.mdl",
        bone = "RW_Weapon",
        rel = "",
        pos = Vector(0.3, -1, 6),
        angle = Angle(-90, 0, 100),
        size = Vector(1, 1, 1),
